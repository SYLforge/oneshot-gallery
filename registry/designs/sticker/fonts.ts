import { Black_Han_Sans, Gaegu, Inter } from "next/font/google";
 ...
 *   system-default sans.
 * Inter — the English voice: the wordmark subtitle, English labels, the
 *   marquee slogans.
 *
 * styles.css consumes these as var(--font-display) / var(--font-gaegu) /
 * var(--font-inter); page.tsx applies the .variable classes on the root.
 *
